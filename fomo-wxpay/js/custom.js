...
function initFormValues() {
    ...
    document.getElementById('nonce').value = Math.floor(Math.random() * 100000000);
}

function submitForm() {
    calculateSignature();
    document.getElementById('fomopayForm').submit();
}
...
function calculateSignature() {
    ...
    upstreams: document.getElementById('upstreams').value
    };
